...
async def on_message(message):
    ...
    if message.content.startswith('leftshark'):
        await message.channel.send(file=discord.File('leftshark.png'))
    if message.content.startswith('rightshark'):
        await message.channel.send(file=discord.File('rightshark.png'))    
